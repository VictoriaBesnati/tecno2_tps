class pinceladas {
  ...
  void cambios(boolean grave, boolean agudo, boolean sonido, float pitch, boolean alto, boolean bajo) {
  ...
  void dibujar() {
    ...
    case 3:
      ...
      p.image(pir[r[0]], -200+x1, 75+x1, tx, ty);//Rojo
      p.image(pia[r[0]], -200+x2, 44+x2, tx, ty);//Amarillo
      p.pop();
      //-----------------------
      p.push();
      ...
      p.image(pir[r[1]], -140+x1, -220+x1, tx, ty);//Rojo
      p.image(pia[r[1]], 60+x2, -140+x2, tx, ty);//Amarillo
      p.pop();
      //-----------------------
      p.push();
      ...
      p.image(pir[r[2]], 140+x1, 285+x1, tx, ty);//Rojo
      p.image(pia[r[2]], 70+x2, 150+x2, tx, ty);//Amarillo
      p.pop();
      //-----------------------
      break;
      //==========================
    case 4:
      ...
      p.image(pir[r[3]], 300+x1, -100+x1, tx, ty);//Rojo
      p.image(pia[r[3]], 100+x2, -20+x2, tx, ty);//Amarillo
      p.pop();
      break;
      //======================
    case 5:
